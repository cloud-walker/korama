...
This file tells the AI how to maintain the `docs/` folder as the codebase evolves. Read it before creating or modifying anything in `docs/proposals/` or `docs/decisions/`.
